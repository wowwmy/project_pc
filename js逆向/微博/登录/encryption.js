...
makeRequest = function (a, b, c, d, _code, _rsakv, _rsaPubkey, _servertime, _nonce) {
    var e = {
        entry: "weibo",
        gateway: 1,
        from: "",
    ...
    e = objMerge(e, {});
    e = objMerge(e, _code);
    e.su = sinaSSOEncoder.base64.encode(encodeURIComponent(a));
    e.service = 'miniblog';
    // var _nonce = makeNonce(6);
    if (1) {
        e.servertime = _servertime;
        e.nonce = _nonce;
        e.pwencode = "rsa2";
        e.rsakv = _rsakv;
        var f = new sinaSSOEncoder.RSAKey;
        f.setPublic(_rsaPubkey, "10001");
        b = f.encrypt([_servertime, _nonce].join("\t") + "\n" + b)
    }
    e.sp = b;
    e.sr = "1536*864"
...
function get_login(user, pwd, code, _rsakv, _rsaPubkey, _servertime, _nonce) {
    var a = user,
        b = pwd,
        c = 7,
        d = false,
        code = code;
    return makeRequest(a, b, c, d, code, _rsakv, _rsaPubkey, _servertime, _nonce)
}
...
// d = false
// // 验证码
// code = {pcid: 'tc-a15e9ebbf5db281fb12029f88b376b01e985', door: 'ghn8h', vsnf: 1}
// // 公钥信息
// _exectime = 8
// _servertime = 1679544678
// _rsakv = "1330428213"
// _rsaPubkey = ''
// _nonce = "V7C7RQ"
// console.log(makeRequest(a, b, c, d, code, _rsakv, _rsaPubkey, _servertime,_nonce))