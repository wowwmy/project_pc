...
makeRequest = function (a, b, c, d, _code, _rsakv, _rsaPubkey, _servertime) {
    var e = {
        entry: "weibo",
        gateway: 1,
        from: "",
    ...
    e = objMerge(e, {wsseretry: 'servertime_error'});
    e = objMerge(e, _code);
    e.su = btoa(encodeURIComponent(a));
    e.service = 'miniblog';
...
console.log(makeRequest(a, b, c, d, code, _rsakv, _rsaPubkey))