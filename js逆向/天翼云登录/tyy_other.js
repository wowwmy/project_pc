...
const dom = new JSDOM('<!DOCTYPE html><p>hellp</p>',{url: 'https://m.ctyun.cn/wap/main/auth/login'});
...
getTimestampOffset = function() {
            return localStorage.getItem("timestampOffset") || ff
        }
getMainVersion = function() {
            return p || localStorage.getItem("mainVersion")
        }
H = function() {
            var e, n, t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 32, a = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 16, r = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz".split(""), i = [];
            if (a = a || r.length,
            t)
                for (e = 0; e < t; e++)
                    i[e] = r[0 | Math.random() * a];
            else
                for (i[8] = i[13] = i[18] = i[23] = "-",
                i[14] = "4",
                e = 0; e < 36; e++)
                    i[e] || (n = 0 | 16 * Math.random(),
                    i[e] = r[19 === e ? 3 & n | 8 : n]);
            return i.join("")
        }
function S(t, e, n) {
...
// 获取参数
function get_other(param) {
var n = (new Date).getTime() - getTimestampOffset()
              , t = "s54zv9bm1vd5czfujy6nnuxj1l4g2ny6"
              , a = Object(H)()
              , r = S(n + a + S(a + t + n));
return params = Object.assign(param || {}, {
